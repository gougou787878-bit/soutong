        ...
        var index = config.pages > groups
            ...
            , views = {
                ...
                , page: function () {
                    ...
                    //输出输出右分隔符 & 末页
                    if (false && config.pages > groups && config.pages > end && config.last !== false) {
                ...
                , next: function () {
                    ...
                    if (config.next) {
                        return '<a href="javascript:;" class="layui-laypage-next' + (config.curr == config.pages ? (' ' + DISABLED) : '') + '" data-page="' + (config.curr + 1) + '">' + config.next + '</a>'
                    } else {
                        return '';
                    }
                }()
