...
;layui.define(function (exports) {
    ...
    if (run) {
        layui.use(["admin", "carousel", "echarts"], function () {
            var $ = layui.$,
                ...
                echart_config = [{
                    ...
                    xAxis: [{
                        ...
                        data: [
                            ...
                            "09:30", "10:00", "11:30", "12:00", "12:30", "13:00", "13:30",
                ...
                chartContainer = $("#LAY-index-dataview").children("div"),
            ...
            if (chartContainer[0]) {
                ...
                var number = 0,
                    /**
                     *
                     * @param obj 轮播对象 {"index":"当前条目的索引 ","prevIndex":"上一个条目的索引",item:"当前条目的元素对象" }
                     */
                    eventChangeFn = function (obj) {
                        chartRender(number = obj.index)
                    };


                carousel.on("change(LAY-index-dataview)", eventChangeFn);
                ...
                layui.admin.on("hash(tab)", function () {
                    layui.router().path.join("") || chartRender(number)
                })
            }
        });
        layui.use("table", function () {
            ...
            table.render({
                ...
                cols: [[
                    ...
                    {
                        field: "keywords", title: "关键词", minWidth: 300,
    ...
    var config = {
        echarts: function (callback) {
            layui.use(["admin", "carousel", "echarts"], callback)
        }
    };


    exports("console", {admin: layui.admin, echarts: config.echarts})
});