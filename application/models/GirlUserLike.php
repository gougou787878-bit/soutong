 ...
 * @mixin \Eloquent
 */
class GirlUserLikeModel extends EloquentModel
{

    protected $table = "girl_user_like";
    ...
    {
        return $this->hasOne(GirlModel::class, 'id', 'related_id');
    }
    ...
    {
        return self::with(['girl' => function($query){
            $query->with('topic:id,name')
                ->select(['id', 'title', 'is_best', 'view_num', 'favorite_num', 'aff', 'topic_id', 'like_num','comment_num','created_at'])
