...
class UserlotteryController extends BackendBaseController
{
    ...
    {
        return function (UserLotteryModel $item) {
            return $item;
        };
    }
    ...
    public function addLotteryTimesAction(){
        try {
            ...
            UserLotteryModel::addUserLottery($member, $val);
